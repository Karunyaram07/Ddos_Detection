...
def build_autoencoder(input_dim, encoding_dim=8):
    ...
    - encoding_dim: size of bottleneck
    """
    input_layer = Input(shape=(input_dim,))
    # encoder
    e = Dense(max(16, encoding_dim*2), activation="relu")(input_layer)
    bottleneck = Dense(encoding_dim, activation="relu")(e)
    # decoder
    d = Dense(max(16, encoding_dim*2), activation="relu")(bottleneck)
...
def train_autoencoder_from_npy(npy_path,
                               ...
                               verbose=1):
    """
    Load X from npy, train autoencoder, save model, history, and loss plot.
